...
exports.sendTicket = (to, paymentNo, callback) => {
     ...
     var mailOptions = {
          ...
          html:
               ...
               '<p>Click <a href="http://asi-qa-test.m-sas.com/api/v4/payments/' +
               paymentNo +
               '.pdf"> here </a> to get your ticket. You need Adobe Acrobat Reader 6.0 or above to open the file.</p>' +
